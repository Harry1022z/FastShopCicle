    ...
    public partial class Corregir : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacturasEntrada", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FacturasEntrada_Proveedores_ProveedorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProveedorId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inventarios_Vendedores_VendedorId",
                        column: x => x.VendedorId,
                        principalTable: "Vendedores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacturasEntrada_ProveedorId",
                table: "FacturasEntrada",
                column: "ProveedorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventarios_VendedorId",
                table: "Inventarios",
                column: "VendedorId");
